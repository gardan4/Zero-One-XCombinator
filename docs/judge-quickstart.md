...
Run a finetuned checkpoint locally or batch-eval on Leonardo. Organizer `eval_metrics.py` and
kickoff CSVs may not be in the repo — see [track-industrial-sources.md](track-industrial-sources.md).
